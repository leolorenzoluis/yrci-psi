                ...
                {appStateContext?.state.isCosmosDBAvailable?.status !== CosmosDBStatus.NotConfigured && (
                  <CommandBarButton
                    ...
                    styles={{
                      ...
                      root: {
                        color: '#FFFFFF',
                        background: 'radial-gradient(106.04% 106.06% at 100.1% 90.19%, #041E42 33.63%, #205493 100%);'
                      },
                      rootDisabled: {
                        background: '#F0F0F0'
                      },
                      ...
                      rootHovered: {
                        background: 'radial-gradient(106.04% 106.06% at 100.1% 90.19%, #0A305F 33.63%, #3470B8 100%);'
                      }
                    }}
                ...
                {/* <CommandBarButton
                  ...
                  styles={{
                    ...
                    root: {
                      color: '#FFFFFF',
                      background:
                        'radial-gradient(109.81% 107.82% at 100.1% 90.19%, #041E42 33.63%, #1A4480 70.31%, #2E73B4 100%);'
                    },
                    rootDisabled: {
                      background: '#F0F0F0'
                    }
